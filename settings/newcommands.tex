...
\newcommand{\fatwhitel}[1]{\multicolumn{1}{|c|}{\textcolor{white}{\textbf{#1}}}}
...
\DeclareDocumentCommand{\wrapfig}{O{l} m m O{nocap} O{nolab}}{
	\begin{wrapfigure}{#1}{#2\linewidth}\includegraphics[width={.95\linewidth}]{#3}\vspace*{-3ex}\caplab{#4}{#5}\end{wrapfigure}}
\DeclareDocumentCommand{\nicetab}{m m O{nocap} O{nolab}}{
	\begin{table}[ht!]\centering\setlength\extrarowheight{5pt}
		...
		\begin{tabular}{#1}\rowcolor{PineGreen}\tline{.5}
			#2
		\end{tabular}
		\caplab{#3}{#4}
	\end{table}}
